...
function App() {
  ...
  let WorkItemDB = [
    {
      id: "1", leftName: "AKS", leftData: "СЕНТЯБРЬ • 2019 – ДЕКАБРЬ • 2020",
      rightDiscribe: "Начал с младшего помошника, в мои обязанности входили продажа аксессуаров для мобильных телефонов, установка защитных стекол, ремонт телефонов, слежение за порядком на торговой точке. Через 4 месяца получил должность старшего ответственного по 2 торговым точкам, после чего в мои обязаностти входило составление расписания, ведение финансов, слежение за персоналом, решение проблем при наличии.",
      rightBubble: ["Коммуникабельность", "Финансовая Отчетность", "Грамотная Речь", "Выявление потребностей"],
    },
    {
      id: "2", leftName: "Ростелеком", leftData: "ДЕКАБРЬ • 2020 – МАЙ • 2021",
      rightDiscribe: "Холодные звонки, продажа услуг напрямую по квартирам. Раздача листовок с тарифами.",
      rightBubble: ["Трата времени", "Рабский труд", "Настойчивость"],
    },
    {
      ...
      rightBubble: ["Архитектура крупной компании", "Деловое общение", "Управление проектами", "Отчетность", "Ответственность"],
    },
    {
      id: "4", leftName: "Администратор", leftData: "ДЕКАБРЬ • 2016 – ИЮЛЬ • 2021",
      rightDiscribe: "Работа хоккейным администратором, в мои обязанности входило: организация тренировок, сбор хоккеистов, ведение финансов, сбор оплаты за тренировки, поиск - добор хоккеистов при недостатке, отчетность по тренировкам, слежение за инвентарем.",
      rightBubble: ["Общение", "Отчетность", "Управление людскими ресурсами", "Ответственность"],
    },
