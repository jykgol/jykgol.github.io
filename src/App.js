      ...
      <div className="page_4">
        <div className="page_4_container _container flex_coloumn">
          ...
          <div className="page_4_subtitle regular_text"> Кратко о себе: 24 года, молодой, значит, не успел еще разочароваться в жизни.
            ...
            ПЕТЕРБУРГСКИЙ ГОСУДАРСТВЕННЫЙ УНИВЕРСИТЕТ ПУТЕЙ СООБЩЕНИЯ ИМПЕРАТОРА АЛЕКСАНДРА I по специальности <i>"Информационная безопасность
            автоматизированных систем на транспорте"</i>, в целом было весело, однако успел разочароваться в системе образования. Понял, как все
